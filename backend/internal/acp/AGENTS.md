...
> 规格在 [`../../../docs/spec/acp-integration.md`](../../../docs/spec/acp-integration.md)，改这里之前必须读完。
...
完整规则见 [`../../../docs/rules/design-principles.md`](../../../docs/rules/design-principles.md) §4.4。
...
> [`../../../docs/notes/acp-field-notes.md`](../../../docs/notes/acp-field-notes.md) 的**本机实测**，
> 每一条前一个项目都真实踩过。
