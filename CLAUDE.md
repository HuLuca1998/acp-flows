...
| 需要 Codex 做独立审查 / 干活 | `codex-collab` | 本项目的双 AI 协作靠它落地，见 [`docs/rules/ai-workflow.md`](docs/rules/ai-workflow.md) |
| 提交 / 开 PR / 合并 | `gh-commit` `gh-pr` `gh-pass` | 分支与提交规范见 [`docs/rules/git-workflow.md`](docs/rules/git-workflow.md) |
...
[`docs/rules/ai-workflow.md`](docs/rules/ai-workflow.md)。**开始跨端协作前必读。**
