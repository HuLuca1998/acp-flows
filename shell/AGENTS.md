...
4. **自动更新**（updater 插件），见 [`../docs/release-and-update.md`](../docs/release-and-update.md)
...
- [`../docs/architecture.md`](../docs/architecture.md) §2 进程模型、§6 壳的职责
- [`../docs/release-and-update.md`](../docs/release-and-update.md) —— 更新流程，尤其 `prepare` 那一步
- [`../docs/coding-standards.md`](../docs/coding-standards.md) §5 Rust 规范
