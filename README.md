...
[**GNU AGPL-3.0**](LICENSE) · Copyright © 2026 Luca <luca218691@gmail.com>

一句话版本：

- ✅ **随便用、随便改、随便分发**——个人、公司、学校都一样，不设门槛
- ⚠️ 但**你改过的版本一旦对外提供**（分发出去，或者架成网络服务给别人用），
  就必须把改动后的完整源码以同样的 AGPL-3.0 公开

### 为什么是 AGPL 而不是 MIT

MIT / Apache-2.0 允许任何人拿走代码、闭源、改个名字卖钱，一行不回馈。
AGPL 是 OSI 认可的协议里**防这件事最有力的一个**：拿去改可以，但改完得亮出来。

「架成网络服务」这一条是 AGPL 相对 GPL 的关键补强——没有它，
公司可以把改造版做成 SaaS 对外收费而永远不算「分发」，因此不必开源。

对个人用户来说这条协议毫无负担：自己用、自己改，怎么折腾都行，
只有当你把改过的版本**给到别人**时，才需要一并给出源码。

想在闭源产品里使用本项目，请联系 <luca218691@gmail.com> 商谈商业授权。
